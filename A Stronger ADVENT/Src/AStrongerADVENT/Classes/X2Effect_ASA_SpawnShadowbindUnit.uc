class X2Effect_ASA_SpawnShadowbindUnit extends X2Effect_SpawnUnit config(GameData_SoldierSkills);
...
function vector GetSpawnLocation(const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState)
{
	...
	{
		`Redscreen("Attempting to create X2Effect_ASA_SpawnShadowbindUnit without a target location! @dslonneger");
		return vect(0, 0, 0);
	}
