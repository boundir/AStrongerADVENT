class AStrongerADVENT_Ability_Sectopod extends X2Ability
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(SectopodLightningStormAttack());
...
static function X2AbilityTemplate SectopodLightningStorm()
{
	...
	Template = PurePassive('SectopodLightningStorm', "img:///UILibrary_PerkIcons.UIPerk_lightningfield", false, 'eAbilitySource_Perk');
	Template.AdditionalAbilities.AddItem('SectopodLightningStormAttack');

	return Template;
}

static function X2AbilityTemplate SectopodLightningStormAttack(name TemplateName = 'SectopodLightningStormAttack')
{
	local X2AbilityTemplate								Template;
	...
	//BEGIN AUTOGENERATED CODE: Template Overrides 'SectopodLightningStormAttack'
	Template.bFrameEvenWhenUnitIsHidden = true;
	//END AUTOGENERATED CODE: Template Overrides 'SectopodLightningStormAttack'
